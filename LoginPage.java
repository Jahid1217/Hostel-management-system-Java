...
public class LoginPage implements ActionListener {
   ...
   // Room1 r;
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == Login && UsernameTextField.getText().isEmpty()==false && PasswordField.getText().isEmpty()==false) {
            ...
            try {
                FileReader fr = new FileReader("F:\\vscode practises\\My Project\\MyHostelexperiment\\meeeeee\\TXTFILES\\Login.txt");
        ...
        if(e.getSource()==Login &&  UsernameTextField.getText().isEmpty()==true && PasswordField.getText().isEmpty()==false){
            JOptionPane.showMessageDialog(null, "Please input Username");
        }
         if(e.getSource()==Login &&  UsernameTextField.getText().isEmpty()==false && PasswordField.getText().isEmpty()==true){
            JOptionPane.showMessageDialog(null, "Please input Password");
        }
         if(e.getSource()==Login &&  UsernameTextField.getText().isEmpty()==true && PasswordField.getText().isEmpty()==true){
