...
public class Room12 extends JFrame implements ActionListener {
	...
	public Room12() {
		...
		lblNewLabel.setIcon(new ImageIcon("Room3.jpg"));
		lblNewLabel.setBounds(10, 18, 354, 275);
		frame.getContentPane().add(lblNewLabel);

		JLabel lblNewLabel_1 = new JLabel("");
		lblNewLabel_1.setIcon(new ImageIcon("RoomD.png"));
		lblNewLabel_1.setBounds(374, 30, 433, 229);
