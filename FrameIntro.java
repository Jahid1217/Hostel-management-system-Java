	...
	public ImageIcon resize(String imgPath)
  {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		if (ae.getSource() == addBtn) {
			...
			if (s5 == "Student") {
				try {
					FileWriter fw = new FileWriter("F:\\vscode practises\\My Project\\MyHostelexperiment\\meeeeee\\TXTFILES\\DataStudent.txt", true);
				...
				try {
					FileWriter fw = new FileWriter("F:F:\\vscode practises\\My Project\\MyHostelexperiment\\meeeeee\\TXTFILES\\DataEmmplyee.txt", true);
					fw.write(idTF.getText() + " " + fnameTF.getText() + " " + phoneTF.getText() + " "
							+ emailTF.getText() + " " + s3 + " " + addressTF.getText() + " " + "\r\n");
					fw.close();
