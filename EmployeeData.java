...
public class EmployeeData extends JFrame implements ActionListener {
	...
	public EmployeeData() {
		...
		/*String[][] data = {
				{ "22-47010-1", "Jahid Hasan", "01708769578", "Jahid.hasan@gmail.com", "Male", "South Pikepara",
						 "2365" },
				{ "22-47010-1", "Jahid Hasan", "01708769578", "Jahid.hasan@gmail.com", "Male", "South Pikepara",
						 "2365" }
		};*/
	...
	public void Read() {
		...
		try {
			File file = new File("F:\\vscode practises\\My Project\\MyHostelexperiment\\meeeeee\\TXTFILES\\DataEmmplyee.txt");
